        ...
        return (
          <li key={item.to}>
            <NavigationMenuLink asChild>
              <Link
                to={item.to}
                className="group relative flex select-none items-start gap-3 border border-transparent bg-white p-3.5 leading-none no-underline outline-none transition-all duration-200 hover:border-slate-300 hover:bg-slate-50 focus-visible:border-slate-950"
              >
                <span className="mt-0.5 inline-flex h-10 w-10 shrink-0 items-center justify-center border border-slate-200 bg-slate-50 text-slate-700 transition-all duration-200 group-hover:border-[#ffb804] group-hover:bg-[#ffb804] group-hover:text-slate-950">
    ...
    <header className="sticky top-0 z-50 border-b border-slate-300 bg-white">
      <div className="mx-auto flex h-[88px] w-full max-w-[1400px] items-center justify-between gap-8 px-6 lg:px-10">
        ...
        <div className="hidden items-center md:flex">
          <Button asChild size="lg" className="h-12 rounded-none border border-[#ffb804] bg-[#ffb804] px-7 text-[14px] font-extrabold uppercase tracking-[0.01em] text-slate-950 shadow-none transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#f2aa00] hover:shadow-[0_8px_20px_rgba(15,23,42,0.12)]">
            <Link to="/contact">Let's talk<ArrowRight className="ml-2 h-4 w-4 transition-transform duration-200 group-hover:translate-x-1" /></Link>
          </Button>
        </div>
