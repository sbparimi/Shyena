    ...
    <aside className="hidden lg:block lg:w-[258px] lg:shrink-0">
      <div className="sticky top-[92px] rounded-2xl border border-border bg-card/80 p-3 shadow-card backdrop-blur-xl">
        <button
          ...
          aria-expanded={open}
          className="flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-sm font-semibold text-foreground transition-colors hover:bg-secondary"
        >
    ...
    <div className="lg:hidden">
      <div className="rounded-2xl border border-border bg-card/80 p-3 shadow-card backdrop-blur-xl">
        <button
          ...
          onClick={() => setOpen((value) => !value)}
          aria-expanded={open}
          className="flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-sm font-semibold text-foreground"
        >
          <BookOpen className="h-4 w-4 text-primary" />
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-primary/10 font-semibold text-primary" : "text-muted-foreground hover:bg-secondary hover:text-foreground",
                  )}
                >
                  {item.label}
                </Link>
