...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [
    ...
    { property: "og:title", content: "Shyena — Enterprise AI Agent Assurance Platform" }, { property: "og:description", content: "Understand the system. Test the behavior. Defend the release. Produce evidence-backed AI release decisions." }, { property: "og:type", content: "website" }, { property: "og:site_name", content: "Shyena" }, { property: "og:image", content: "https://www.shyena.eu/shyena-logo-exact.webp" },
    { name: "twitter:card", content: "summary_large_image" }, { name: "twitter:title", content: "Shyena — Enterprise AI Agent Assurance Platform" }, { name: "twitter:description", content: "Evidence-backed assurance for AI agents." }, { name: "twitter:image", content: "https://www.shyena.eu/shyena-logo-exact.webp" },
  ], links: [
    { rel: "stylesheet", href: appCss }, { rel: "stylesheet", href: siteThemeCss }, { rel: "preconnect", href: "https://fonts.googleapis.com" }, { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" }, { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&family=Sora:wght@600;700;800&display=swap" }, { rel: "icon", href: "/favicon.svg?v=20260906", type: "image/svg+xml" }, { rel: "apple-touch-icon", href: "/favicon.svg?v=20260906" },
  ] }),
