...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [
    ...
    { property: "og:title", content: "Shyena — Autonomous Quality Engineering" }, { property: "og:description", content: "Test. Evaluate. Secure. Prove. Know if your AI system is ready for production." }, { property: "og:type", content: "website" }, { property: "og:site_name", content: "Shyena" }, { property: "og:image", content: "https://www.shyena.eu/shyena-logo-lockup.svg?v=20260906" },
    { name: "twitter:card", content: "summary_large_image" }, { name: "twitter:title", content: "Shyena — Autonomous Quality Engineering" }, { name: "twitter:description", content: "Test, evaluate and secure AI systems with evidence-backed release decisions." }, { name: "twitter:image", content: "https://www.shyena.eu/shyena-logo-lockup.svg?v=20260906" },
  ], links: [
    { rel: "stylesheet", href: appCss }, { rel: "stylesheet", href: siteThemeCss }, { rel: "stylesheet", href: enterpriseTypographyCss }, { rel: "preconnect", href: "https://fonts.googleapis.com" }, { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" }, { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&family=Sora:wght@600;700;800&display=swap" }, { rel: "icon", href: "/shyena-mark.svg?v=20260906", type: "image/svg+xml" }, { rel: "apple-touch-icon", href: "/shyena-mark.svg?v=20260906" },
  ] }),
