...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [
    ...
    { property: "og:title", content: "Shyena — Enterprise AI Agent Assurance Platform" }, { property: "og:description", content: "Understand the system. Test the behavior. Defend the release. Produce evidence-backed AI release decisions." }, { property: "og:type", content: "website" }, { property: "og:site_name", content: "Shyena" }, { property: "og:image", content: "https://www.shyena.eu/shyena-logo-lockup.svg?v=20260906" },
    { name: "twitter:card", content: "summary_large_image" }, { name: "twitter:title", content: "Shyena — Enterprise AI Agent Assurance Platform" }, { name: "twitter:description", content: "Evidence-backed assurance for AI agents." }, { name: "twitter:image", content: "https://www.shyena.eu/shyena-logo-lockup.svg?v=20260906" },
  ], links: [
