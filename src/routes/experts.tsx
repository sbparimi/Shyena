...
export const Route = createFileRoute("/experts")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "https://shyena.eu/experts" }],
  }),
  ...
  return (
    <main className="min-h-screen bg-white text-[#17233f]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        ...
        <p className="mt-5 text-center text-[11px] leading-5 text-[#7a8290]">Corporate profile identities are rendered as part of the Shyena design system.</p>
