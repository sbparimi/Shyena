...
export const Route = createFileRoute("/autonomous-testing")({
  head: () => ({ meta: [
    ...
    { property: "og:title", content: "Autonomous AI Testing & Quality Engineering | Shyena" },
    { property: "og:description", content: "Give Shyena a quality goal and connect system understanding, autonomous test engineering, execution, failure forensics and release evidence." },
    { property: "og:type", content: "website" }, { property: "og:site_name", content: "Shyena" },
    { property: "og:url", content: `${SITE}/autonomous-testing` }, { property: "og:image", content: `${SITE}/shyena-logo-lockup.svg?v=20260917` },
    { name: "twitter:card", content: "summary_large_image" }, { name: "twitter:title", content: "Autonomous AI Testing & Quality Engineering | Shyena" },
    { name: "twitter:description", content: "Autonomous test engineering, execution and failure investigation with release evidence." }, { name: "twitter:image", content: `${SITE}/shyena-logo-lockup.svg?v=20260917` },
  ]}),
...
function AutonomousTestingPage() {
  return <>
    <ExecutivePage
      ...
      proof={[{ label: "Input", value: "Goal / requirement" }, { label: "Reason", value: "Risk + test intent" }, { label: "Execute", value: "Right engine" }, { label: "Output", value: "Proof + decision" }]}
    ...
    />
    <section className="border-t border-slate-300 bg-white"><div className="mx-auto max-w-[1440px] px-5 py-12 sm:px-8 sm:py-16 lg:px-10 lg:py-20"><div className="grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center"><div><div className="font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-[#a87900] sm:text-xs">ERP testing</div><h2 className="mt-4 max-w-3xl font-[Sora] text-[clamp(2.2rem,5vw,4.5rem)] font-extrabold leading-[0.94] tracking-[-0.055em]">Oracle Fusion. Business-process aware testing.</h2><p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">Use Claude AI with Shyena to understand configuration, business processes and end-to-end enterprise journeys across Finance, HCM, Supply Chain, Procurement and Projects.</p></div><div className="border border-slate-300 bg-[#f8fafc] p-6 sm:p-8"><div className="grid grid-cols-2 gap-px border border-slate-300 bg-slate-300"><div className="bg-white p-5"><div className="font-mono text-[10px] text-slate-400">UNDERSTAND</div><div className="mt-2 font-extrabold">Configuration</div></div><div className="bg-white p-5"><div className="font-mono text-[10px] text-slate-400">TEST</div><div className="mt-2 font-extrabold">Business process</div></div><div className="bg-white p-5"><div className="font-mono text-[10px] text-slate-400">EVALUATE</div><div className="mt-2 font-extrabold">End-to-end outcome</div></div><div className="bg-white p-5"><div className="font-mono text-[10px] text-slate-400">PROVE</div><div className="mt-2 font-extrabold">Audit evidence</div></div></div><Link to="/contact" className="mt-6 inline-flex items-center gap-2 text-xs font-extrabold uppercase">Discuss ERP assurance <ArrowRight className="h-4 w-4" /></Link></div></div></div></section>
  </>;
}
