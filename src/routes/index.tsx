                  ...
                  <div className="min-w-0 overflow-hidden p-3 sm:p-5">
                    ...
                    <div className="mt-3 rounded-xl border border-white/8 bg-[#0a1121]/75 p-3">
                      ...
                      <div className="relative mt-3 flex items-center gap-1 sm:gap-2">
                        ...
                        <div className="relative z-20 flex h-[88px] w-[88px] shrink-0 items-center justify-center sm:h-[106px] sm:w-[106px]">
                          <motion.div className="absolute inset-0 rounded-full border border-[#e87512]/35" animate={{rotate:360}} transition={{duration:18,repeat:Infinity,ease:"linear"}} />
                          <motion.div className="absolute inset-[5px] rounded-full border-[7px] border-[#26354f] border-t-[#e87512] border-r-[#e87512]" animate={{rotate:360}} transition={{duration:6,repeat:Infinity,ease:"linear"}} />
                          <motion.div className="absolute inset-[12px] rounded-full border border-white/10" animate={{rotate:-360}} transition={{duration:14,repeat:Infinity,ease:"linear"}} />
