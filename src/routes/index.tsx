...
function ComingSoon() {
  return (
    <section className="border-y border-[#2b2350] bg-[#0a071d] text-[#faf8ff]">
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <Reveal delay={80}>
          <div className="mt-10 overflow-hidden rounded-[28px] border border-[#7c3aed]/35 bg-[#15102d] shadow-elevated">
            ...
            <div className="overflow-x-auto"><table className="w-full min-w-[1500px] border-collapse text-left text-[13px]"><thead><tr className="border-b border-[#2b2350] bg-[#0a071d]"><th className="sticky left-0 z-10 w-[190px] bg-[#0a071d] px-5 py-4 font-semibold">Capability</th><th className="w-[210px] px-5 py-4 font-semibold text-[#faf8ff]">DeepEval</th><th className="w-[210px] px-5 py-4 font-semibold text-[#faf8ff]">Promptfoo</th><th className="w-[210px] px-5 py-4 font-semibold text-[#faf8ff]">Confident AI</th><th className="w-[210px] px-5 py-4 font-semibold text-[#faf8ff]">Phoenix / Arize</th><th className="w-[210px] px-5 py-4 font-semibold text-[#faf8ff]">LangSmith</th><th className="sticky right-0 z-20 w-[300px] border-l-2 border-[#a855f7] bg-[#7c3aed] px-5 py-4 font-bold text-[#faf8ff] shadow-[-10px_0_24px_-14px_rgba(168,85,247,0.65)]">Shyena assurance system</th></tr></thead><tbody>{ASSURANCE_COMPARISON.map(([capability, deepeval, promptfoo, confident, phoenix, langsmith, shyena]) => <tr key={capability} className="border-b border-[#2b2350] align-top"><td className="sticky left-0 z-10 bg-[#15102d] px-5 py-4 font-semibold text-[#faf8ff]">{capability}</td><td className="px-5 py-4 leading-relaxed text-[#c9c4d8]">{deepeval}</td><td className="px-5 py-4 leading-relaxed text-[#c9c4d8]">{promptfoo}</td><td className="px-5 py-4 leading-relaxed text-[#c9c4d8]">{confident}</td><td className="px-5 py-4 leading-relaxed text-[#c9c4d8]">{phoenix}</td><td className="px-5 py-4 leading-relaxed text-[#c9c4d8]">{langsmith}</td><td className="sticky right-0 z-20 border-l-2 border-[#a855f7] bg-[#7c3aed] px-5 py-4 font-semibold leading-relaxed text-[#faf8ff] shadow-[-10px_0_24px_-14px_rgba(168,85,247,0.55)]">{shyena}</td></tr>)}</tbody></table></div>
            <div className="grid gap-3 border-t border-[#2b2350] bg-[#15102d] p-5 sm:grid-cols-2 lg:grid-cols-4 sm:p-7">{["PLAYWRIGHT", "YAML ASSURANCE CONTRACTS", "DETERMINISTIC + LLM JUDGES", "EVIDENCE-BACKED RELEASE VERDICT"].map((item, index) => <div key={item} className="rounded-xl border border-[#2b2350] bg-[#15102d] px-4 py-4"><div className="font-mono text-[10px] text-primary">0{index + 1}</div><div className="mt-2 text-xs font-semibold leading-relaxed">{item}</div></div>)}</div>
          </div>
        </Reveal>
        <Reveal delay={120}>
...
function Index() {
  return (
    <>
      ...
      <section className="border-b border-[#2b2350] bg-[#0a071d]">
