...
const SLUG = "ai-agent-testing-is-a-systems-problem";

export const Route = createFileRoute("/blog/ai-agent-testing-is-a-systems-problem")({
  head: () => {
    ...
    return {
      ...
      links: [{ rel: "canonical", href: `https://shyena.eu/blog/${SLUG}` }],
    };
  },
        ...
        <div className="mx-auto w-full max-w-4xl px-5 pb-10 pt-20 sm:px-8 sm:pt-28">
          <div className="text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-border bg-secondary px-3.5 py-1.5 text-xs font-medium text-primary">
              {article.category || "AI Agent Assurance"}
            </span>
        ...
        <div className="mt-16 rounded-2xl border border-navy-border bg-navy px-6 py-10 text-center sm:px-10">
          ...
          <Button asChild size="lg" className="mt-6">
            <Link to="/docs/evaluation-model">
              Read the evaluation model <ArrowRight className="h-4 w-4" />
            </Link>
          </Button>
        </div>
