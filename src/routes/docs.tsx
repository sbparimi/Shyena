...
import { BookOpen, Search, ArrowRight, Sparkles, Workflow } from "lucide-react";
      ...
      <section className="mx-auto w-full max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
        <div className="grid gap-10 lg:grid-cols-[258px_minmax(0,1fr)] lg:items-start lg:gap-12">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-10 flex flex-col items-start justify-between gap-6 rounded-3xl border border-primary/20 bg-primary/5 px-6 py-8 sm:flex-row sm:items-center sm:px-10 sm:py-10">
              <div className="max-w-2xl"><div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.16em] text-primary"><Sparkles className="h-3.5 w-3.5" />Content engineering</div><h3 className="mt-3 text-xl font-bold sm:text-2xl">Documentation is part of the assurance system.</h3><p className="mt-2 text-muted-foreground">SAGE can research, draft, review, validate and publish technical knowledge through the same content-as-code path used for engineering changes.</p></div>
              <Button asChild size="lg" className="shrink-0"><Link to="/docs/sage-content-engineering">View SAGE architecture <Workflow className="h-4 w-4" /></Link></Button>
            </div>
          </div>
        </div>
      </section>
