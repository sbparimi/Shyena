...
const assurancePlans = [
  ...
  },
  {
    ...
    price: "€18,000",
    cadence: "/ year",
    body: "Continuous assurance for one production AI system after the pilot.",
    items: [
...
const autonomousPlans = [
  ...
  },
  {
    ...
    price: "€12,000",
    cadence: "/ year",
    body: "Autonomous testing for web applications and APIs without per-seat licensing.",
    items: [
